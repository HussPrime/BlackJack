...
export default function Model({amount, position, rotation, props}) {
  ...
  if(amount){
    return(
      <group position={position} rotation={rotation} {...props} dispose={null}>
        <mesh geometry={nodes[`Poker_Chip_${amount}`].geometry} material={materials[`Poker_chip_${amount}`]} position={[-0.125, 0, 0]} />
      </group>
    )
  }
